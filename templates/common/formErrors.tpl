 ...
 *
 * Copyright (c) 2021-2025 Madi Nuralin
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * List errors that occurred during form processing.
 *}
{if $isError}
	<div id="formErrors" class="font-medium text-red-600">
		<span class="pkp_form_error">{translate key="form.errorsOccurred"}:</span>
		<ul class="pkp_form_error_list mt-3 list-disc list-inside text-sm text-red-600">
