         ...
         <div class="relative z-10 md:text-center lg:text-left">
            ...
            <div class="relative">
              ...
              <div class="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <a class="rounded-full bg-{$materialColour}-300 py-2 px-4 text-sm font-semibold text-slate-900 hover:bg-{$materialColour}-200 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-{$materialColour}-300/50 active:bg-{$materialColour}-500" href="{url router=$smarty.const.ROUTE_PAGE page="about" op="submissions"}" role="button">
