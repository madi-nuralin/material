...
<html lang="{$currentLocale|replace:"_":"-"}"
	...
	class="font-{$activeTheme->getOption('materialFont')}" 
	{literal}
...
{assign
   var="materialColour"
   value=$activeTheme->getOption('materialColour')}
	...
	<div class="relative mx-auto flex w-full max-w-8xl flex-auto justify-center sm:px-2 lg:px-8 xl:px-12">
		...
		<main class="min-w-0 max-w-2xl flex-auto px-4 py-16 lg:max-w-none lg:pl-8 lg:pr-0 xl:px-16 dark:text-white">
			...
			<article>
				...
				<div  class="prose prose-slate max-w-none prose-a:text-{$materialColour}-400 dark:prose-a:text-{$materialColour}-400 dark:prose-invert dark:text-slate-400 dark:prose-lead:text-slate-400 prose-headings:font-normal">
{else}
